...
describe("platform roles", () => {
  it("exposes only the expected actor roles for the platform", () => {
    ...
    expect(MODULE_ACCESS.groupe).not.toContain("statistiques");
    expect(MODULE_ACCESS.centre).toEqual(MODULE_ACCESS.admin);
    expect(MODULE_ACCESS.centre).toContain("finances");
    ...
    expect(MODULE_ACCESS.chapitre).not.toContain("finances");
    expect(MODULE_ACCESS.chapitre).not.toContain("settings");
